declare module 'stormpath-sdk-angularjs' {
  export = 'stormpath';
}

declare namespace angular.stormpath {
...
declare namespace angular.ui {
  ...
  // Augment ui-router state with stormpath config
  interface IState {
    sp?: angular.stormpath.ISpStateConfig;
  }
