...
var thingIndex = proxyquire.noPreserveCache()('./index.js', {
  express: {
    Router() {
      return routerStub;
    }
...
describe('Thing API Router:', function() {
  ...
  describe('GET /admin/things', function() {
  ...
  describe('GET /admin/things/:id', function() {
  ...
  describe('POST /admin/things', function() {
  ...
  describe('PUT /admin/things/:id', function() {
  ...
  describe('PATCH /admin/things/:id', function() {
  ...
  describe('DELETE /admin/things/:id', function() {
